...
def productAnalytics(request):
	...
	if platf == 'Binkit' :
		...
		# return render(request, 'blinkit/blnkt_product_analytics.html', { 'productanalysis':prdAnalytics, 'username':request.user, 'balance': bal, 'pf_op':platf, 'filters':filter_list, 'DATE':(start_date, end_date), 'data':[], 'O_date':(o_s, o_e, o_d.days+1) })
