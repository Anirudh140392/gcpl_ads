...
def category_table(start_date, end_date):
    ...
    def get_data(start_date,end_date):
        query = f"""
            SELECT 
                ...
                SUM(category_orders)/SUM(category_clicks) AS cvr
            FROM 
                category_data_gcpl
    ...
    data = {}
    data["category"] = current_df["category_name"]
...
category_table(start_date='2025-01-26', end_date='2025-01-27')